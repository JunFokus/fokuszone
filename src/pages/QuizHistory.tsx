  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 max-w-2xl pb-24 lg:pb-8">
      <div className="flex items-center gap-3 mb-6 sm:mb-8">
        ...
        <h1 className="font-bold tracking-tight">{t('history')}</h1>
      </div>
          ...
          {quizzes.map((quiz) => (
            <div key={quiz.id} className="glass rounded-xl p-4 flex items-center justify-between glass-hover">
              <div className="space-y-1 min-w-0">
                <p className="font-semibold truncate">{quiz.subject}</p>
              ...
              <div className="text-right shrink-0 ml-4">
                <div className={`text-2xl font-bold ${Number(quiz.score_percentage) >= 70 ? 'text-[hsl(var(--success))]' : 'text-destructive'}`}>
